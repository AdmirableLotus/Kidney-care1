...
const MedicationForm = ({ onAdded }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="medication-form">
      ...
      <label>Time(s): <input name="time" value={form.time} onChange={handleChange} placeholder="e.g. 08:00, 20:00" /></label>
      <label>Start Date: <input type="date" name="startDate" value={form.startDate} onChange={handleChange} required /></label>
